...
import AdversaryGuessesModal from '@/components/modals/AdversaryGuessesModal.vue';
...
<template>
  ...
  <CreatePoolModal
    ...
    @create="create.hide()"
  />
  <AdversaryGuessesModal
    :context="adversaries.context.value"
    :variant="modalVariant"
    @close="adversaries.hide()"
  />
</template>
